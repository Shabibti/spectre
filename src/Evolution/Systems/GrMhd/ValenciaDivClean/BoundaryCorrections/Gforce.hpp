 ...
 * those variables.
 */
class Gforce final : public BoundaryCorrection {
 private:
 ...
 public:
  ...
  Gforce() = default;
  Gforce(const Gforce&) = default;
  Gforce& operator=(const Gforce&) = default;
  ...
  WRAPPED_PUPable_decl_template(Gforce);  // NOLINT
  /// \endcond
