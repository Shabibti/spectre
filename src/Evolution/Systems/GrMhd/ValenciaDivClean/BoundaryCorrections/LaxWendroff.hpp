 ...
 * those variables.
 */
class LaxWendroff final : public BoundaryCorrection {
 private:
 ...
 public:
  ...
  LaxWendroff() = default;
  LaxWendroff(const LaxWendroff&) = default;
  LaxWendroff& operator=(const LaxWendroff&) = default;
  LaxWendroff(LaxWendroff&&) = default;
  LaxWendroff& operator=(LaxWendroff&&) = default;
  ~LaxWendroff() override = default;

  /// \cond
  explicit LaxWendroff(CkMigrateMessage* /*unused*/);
  using PUP::able::register_constructor;
  WRAPPED_PUPable_decl_template(LaxWendroff);  // NOLINT
  /// \endcond
